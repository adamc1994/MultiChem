function [Cfinal, Yield, TimeData, ConcData] = VdV_Constants(ConcA, T, res_time)
%{
...
Co = [ConcA zeros(1,3)]; % initial conc
Co = [Co; zeros(n-1,4)];
Co = reshape (Co, 1, []);


Ea = [8.1131e4 8.1131e4 7.1168e4]; % J/mol
ko = [2.1450e10 2.1450e10 0.0151e10]; % min-1 for first order, M-1 min-1 for second order
...
[TimeData,ConcData] = ...
    ode45(@VdV_Equations,[0 res_time*4],yo, options);
%{
---------------------------------------------------------------------------
